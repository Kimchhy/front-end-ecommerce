    ...
    <div class="row">
        ...
        <div class="col-7 pt-4">
            <div class="input-group mb-3">
                <input type="text" class="form-control" placeholder="សូមបញ្ចូលឈ្មោះទំនិញ..." aria-label="Recipient's username" aria-describedby="button-addon2">
    ...
    <div class="row">
        <div class="col-12">
            <nav class="navbar navbar-expand-lg bg-secondary-subtle">
                <div class="container-fluid">
                  <a class="navbar-brand" href="#"     <button class="btn btn-primary" type="button" data-bs-toggle="offcanvas" data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions"><i class="fa-solid fa-bars"></i></a>
